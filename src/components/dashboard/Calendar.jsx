...
const getEventColor = (type) => {
  const colors = {
    meeting: { 
      background: 'rgba(219, 234, 254, 0.8)', // blue-100 with opacity
      border: '#3B82F6',    // blue-500
      text: '#1E40AF',      // blue-800
      hover: 'rgba(219, 234, 254, 1)'
    },
    deadline: { 
      background: 'rgba(254, 226, 226, 0.8)', // red-100 with opacity
      border: '#EF4444',    // red-500
      text: '#991B1B',      // red-800
      hover: 'rgba(254, 226, 226, 1)'
    },
    call: { 
      background: 'rgba(209, 250, 229, 0.8)', // green-100 with opacity
      border: '#10B981',    // green-500
      text: '#065F46',      // green-800
      hover: 'rgba(209, 250, 229, 1)'
    },
    reminder: { 
      background: 'rgba(254, 243, 199, 0.8)', // yellow-100 with opacity
      border: '#F59E0B',    // yellow-500
      text: '#92400E',      // yellow-800
      hover: 'rgba(254, 243, 199, 1)'
    },
    holiday: { 
      background: 'rgba(243, 232, 255, 0.9)', // purple-100 with opacity
      border: '#8B5CF6',    // purple-500
      text: '#5B21B6',      // purple-800
      hover: 'rgba(243, 232, 255, 1)'
    }
  };
  return colors[type] || { 
    background: 'rgba(229, 231, 235, 0.8)', // gray-200 with opacity
